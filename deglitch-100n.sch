...
N 580 -90 680 -90 {lab=VSS}
N 580 -210 680 -210 {lab=VSS}
...
N 580 -430 680 -430 {lab=VDD}
N 480 -430 500 -430 {lab=VDD}
N 580 -550 680 -550 {lab=VDD}
N 240 -320 240 -290 {lab=v_drv}
N 680 -320 830 -320 {lab=v_cap}
N 820 -350 830 -350 {lab=VDD}
N 690 -550 820 -550 {lab=VDD}
N 820 -290 830 -290 {lab=VSS}
N 690 -90 820 -90 {lab=VSS}
N 680 -550 680 -530 {lab=VDD}
N 680 -110 680 -90 {lab=VSS}
N 680 -140 690 -140 {lab=VSS}
N 690 -140 690 -90 {lab=VSS}
N 680 -90 690 -90 {lab=VSS}
N 680 -500 690 -500 {lab=VDD}
N 690 -550 690 -500 {lab=VDD}
N 680 -550 690 -550 {lab=VDD}
...
N 680 -470 680 -460 {lab=#net2}
N 680 -400 680 -320 {lab=v_cap}
N 530 -320 680 -320 {lab=v_cap}
...
N 680 -320 680 -240 {lab=v_cap}
N 680 -180 680 -170 {lab=#net3}
N 820 -550 820 -350 {lab=VDD}
N 1160 -320 1250 -320 {lab=v_o}
N 820 -290 820 -90 {lab=VSS}
N 190 -500 190 -380 {lab=v_i}
N 190 -500 640 -500 {lab=v_i}
N 190 -260 190 -140 {lab=v_i}
N 190 -140 640 -140 {lab=v_i}
N 720 -430 1160 -430 {lab=v_o}
N 1160 -430 1160 -320 {lab=v_o}
N 1070 -320 1160 -320 {lab=v_o}
N 720 -210 1160 -210 {lab=v_o}
N 1160 -320 1160 -210 {lab=v_o}
N 530 -390 530 -320 {lab=v_cap}
N 240 -320 340 -320 {lab=v_drv}
N 240 -350 240 -320 {lab=v_drv}
N 400 -320 530 -320 {lab=v_cap}
C {/foss/designs/xschem-ihp130-deglitch/xschem-ihp130-schmitt-trigger/comp-schmitt.sym} 900 -320 0 0 {name=x1}
...
C {sg13g2_pr/sg13_lv_pmos.sym} 660 -500 0 0 {name=MP2
l=0.13u
w=1.5u
ng=1
m=1
...
C {sg13g2_pr/sg13_lv_nmos.sym} 660 -140 0 0 {name=MN2
l=0.13u	
w=1.5u
ng=1
m=1
...
C {sg13g2_pr/sg13_lv_pmos.sym} 700 -430 0 1 {name=MP3
l=0.13u
w=1.5u
ng=1
m=1
...
C {sg13g2_pr/sg13_lv_nmos.sym} 700 -210 0 1 {name=MN3
l=0.13u	
w=1.5u
ng=1
m=1
